    ...
    <div className="sidebar-style">
      ...
      <div className="sidebar-widget mt-50">
        ...
        <div className="sidebar-widget-tag mt-25">
          <ul>
            <li>
              <Link to={process.env.PUBLIC_URL + "/blog"}>Clothing</Link>
            </li>
            <li>
              <Link to={process.env.PUBLIC_URL + "/blog"}>Accessories</Link>
            </li>
            <li>
              <Link to={process.env.PUBLIC_URL + "/blog"}>For Men</Link>
            </li>
            <li>
              <Link to={process.env.PUBLIC_URL + "/blog"}>Women</Link>
            </li>
            <li>
              <Link to={process.env.PUBLIC_URL + "/blog"}>Fashion</Link>
            </li>
          </ul>
        </div>
      </div>
